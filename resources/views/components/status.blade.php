...
@elseif($status == 'attended')
    <span class="flex items-center justify-center w-28 sm:w-32 h-6 sm:h-8 text-xs uppercase font-bold text-purple-400 bg-purple-100 rounded-full">
        teilgenommen
    </span>
@elseif($status == 'cancelled')
    <span class="flex items-center justify-center w-28 sm:w-32 h-6 sm:h-8 text-xs uppercase font-bold text-red-500 bg-red-100 rounded-full">
        abgesagt
    </span>
@endif