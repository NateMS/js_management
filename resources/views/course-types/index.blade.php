                    ...
                    @foreach ($courseTypes as $courseType)
                        <tr class="odd:bg-white even:bg-gray-50 text-gray-900 border-b">
                            ...
                            <td class="px-6 py-4 font-medium">
                                ...
                                <form class="inline" action="{{ route('course-types.destroy', $courseType) }}" method="POST" class="d-inline" onsubmit="return confirm('Möchten Sie diesen Kurstyp wirklich löschen?');">
                                    @csrf
                                    @method('DELETE')
